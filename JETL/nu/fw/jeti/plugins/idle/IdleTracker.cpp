 ...
 *  idletrack.c
 *
 *  Modified for use by Jeti by Martin Forssen <maf@appgate.com>. I found
 *  this code in gaim (src/win32/IdleTracker/idletrack.c 1.11) and it was
...
#include <windows.h>
#include "nu_fw_jeti_plugins_idle_IdleTimer.h"
...
JNIEXPORT jlong JNICALL Java_nu_fw_jeti_plugins_idle_IdleTimer_IdleGetLastInputTime
(JNIEnv *, jclass)
{
    DWORD result = 0;
...
JNIEXPORT jboolean JNICALL Java_nu_fw_jeti_plugins_idle_IdleTimer_IdleInit
(JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL Java_nu_fw_jeti_plugins_idle_IdleTimer_IdleTerm
(JNIEnv *, jclass)
{
    if (g_user32 != NULL)
