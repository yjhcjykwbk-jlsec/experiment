...
/**
 * @author E.S. de Boer
 * The listener interface for receiving disco or browse results.
 * The results are cached for later use.
 */
public interface DiscoveryListener extends JETIListener
{

	void discoveryItemResult(JID jid,DiscoveryItem item);
	
	void discoveryInfoResult(JID jid,DiscoveryInfo info);
