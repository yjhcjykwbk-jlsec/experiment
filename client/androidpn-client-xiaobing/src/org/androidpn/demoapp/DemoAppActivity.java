...
public class DemoAppActivity extends Activity {
	...
	protected void onResume() {
        ...
        Log.i("xiaobingo", "listItem�Ĵ�С�ǣ�"+listItem.size()); 
        //�����������Item�Ͷ�̬�����Ӧ��Ԫ�� 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        IsNetworkConn isConn = new IsNetworkConn(DemoAppActivity.this);
		        if (!isConn.isConnected) { //���û����
					...
					/*
		      		...
		      		*/
					//��androidpn server��ȡ�û��Ѷ��ĵ���Ŀ,������	
					StringBuilder parameter = new StringBuilder();
					parameter.append("action=getSubscription"); 
					parameter.append("&userName=");
					parameter.append(originSharedPrefs.getString(Constants.XMPP_USERNAME, "δ֪�û�"));
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Log.i("xiaobingo", "�����ǣ�"+getItemTitle);
				Log.i("xiaobingo", "��Ϣ�ǣ�"+getItemMessage);
				Log.i("xiaobingo", "�����ǣ�"+getItemUri);
				//activity��ת
       ...
       // Button btn_unsubscribe = (Button)findViewById(R.id.btn_unsubscribe);
        ...
        btn_chat.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				bd.putString("Pwd", originSharedPrefs.getString(Constants.XMPP_PASSWORD, "δ֪�û�"));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM0, 0, "�˳���½");
		menu.add(0, MENU_ITEM1, 0, "����б�");
		return true;
	}
