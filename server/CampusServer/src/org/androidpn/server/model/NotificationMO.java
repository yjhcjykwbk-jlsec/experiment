...
public class NotificationMO implements Serializable {
	...
	public static final String STATUS_NOT_SEND = "0"; //未发送
	public static final String STATUS_SEND = "1"; // 发送但未接收
	public static final String STATUS_RECEIVE = "2"; // 发送出且被接受
	public static final String STATUS_READ = "3"; // 发送出且已读
